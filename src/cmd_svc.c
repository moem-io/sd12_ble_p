 ...
 *
 */
static uint32_t cmd_char_add(ble_cmd_svc_t * p_cmd_service)
{
...
void cmd_service_init(ble_cmd_svc_t * p_cmd_service)
{
    ...
    NRF_LOG_INFO("Service UUID: 0x%04x\r\n", service_uuid.uuid); // Print service UUID should match definition BLE_UUID_CMD_SERVICE
